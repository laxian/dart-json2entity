...
Clazz.fromJson(jsonStr).toString();	// 标准实体类
JsonSerializableClazz.fromJson(jsonStr).toString();	// json_serializable风格实体类
```
...
2. `dart bin/cli.dart -j '{"result":1,"msg":"ok"}' -o output/BaseEntity`

3. `./json2entity -j '{"result":1,"msg":"ok"}' -o output/BaseEntity`
