...
# 和上面6种用例一样
inputFile=./sample/input.json

# normal
./json2entity -j $json1 --output ./sample/output/Json1
./json2entity -j $json2 --output ./sample/output/Json2
./json2entity -j $json3 --output ./sample/output/Json3
./json2entity -j $json4 --output ./sample/output/Json4
./json2entity -j $json5 --output ./sample/output/Json5
./json2entity -j $json6 --output ./sample/output/Json6

# json_serializable support
./json2entity -j $json1 --output ./sample/output/JsonS1 -s
./json2entity -j $json2 --output ./sample/output/JsonS2 -s
./json2entity -j $json3 --output ./sample/output/JsonS3 -s
./json2entity -j $json4 --output ./sample/output/JsonS4 -s
./json2entity -j $json5 --output ./sample/output/JsonS5 -s
./json2entity -j $json6 --output ./sample/output/JsonS6 -s

# input from file
./json2entity -f $inputFile --output ./sample/output/
# ./json2entity -f $inputFile --output ./sample/output/ -s
